...
constexpr TStringBuf TEMPLATE_GET_WEATHER = "get_weather";

} // namespace

void TGetWeatherTrRenderHandle::Do(TScenarioHandleContext& ctx) const {
    ...
    bassRenderer.Render(TEMPLATE_GET_WEATHER, "render_result", bassResponseBody);
