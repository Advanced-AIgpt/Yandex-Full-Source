...
constexpr TStringBuf TEMPLATE_SWITCH_LAYER = "switch_layer";

} // namespace

void TSwitchLayerTrRenderHandle::Do(TScenarioHandleContext& ctx) const {
    ...
    bassRenderer.Render(TEMPLATE_SWITCH_LAYER, "render_result", bassResponseBody);
