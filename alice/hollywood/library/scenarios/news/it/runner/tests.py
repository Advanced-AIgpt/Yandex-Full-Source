from alice.hollywood.library.scenarios.news.it.tests_data import TEST_RUN_PARAMS, TESTS_DATA_PATH, SCENARIO_HANDLE, \
...
test_news_run = create_test_function(TESTS_DATA_PATH, TEST_RUN_PARAMS, SCENARIO_HANDLE, usefixtures=['srcrwr_params'])
