import alice.hollywood.library.scenarios.news.it.tests_data as tests_data
...
from alice.hollywood.library.scenarios.news.it.tests_data import srcrwr_params
