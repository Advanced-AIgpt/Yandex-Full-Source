...
from alice.hollywood.library.scenarios.music.it.tests_player_shuffle import TEST_RUN_PARAMS, TESTS_DATA_PATH, SCENARIO_HANDLE,\
    hollywood
...
test_player_shuffle = create_test_function(TESTS_DATA_PATH, TEST_RUN_PARAMS, SCENARIO_HANDLE, usefixtures=['srcrwr_params'])
