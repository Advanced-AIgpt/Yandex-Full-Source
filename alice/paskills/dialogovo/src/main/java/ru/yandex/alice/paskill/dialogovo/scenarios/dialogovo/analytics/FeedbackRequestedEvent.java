...
public class FeedbackRequestedEvent extends AnalyticsInfoEvent {

    public static final FeedbackRequestedEvent INSTANCE = new FeedbackRequestedEvent();

    private FeedbackRequestedEvent() {
        super();
    }
    ...
    protected TEvent.Builder fillProtoField(@Nonnull TEvent.Builder protoBuilder) {
        return protoBuilder.setSkillFeedbackRequested(Dialogovo.TFeedbackRequestedEvent.getDefaultInstance());
    }
}
