...
from smart_home.provider.instances import Range, ColorHSV
from smart_home.provider import action_answers
from smart_home.provider.capabilities import OnOffCapability, LightCapability, BacklightCapability, BrightnessCapability, \
...
logging.basicConfig(format="%(filename)s[line:%(lineno)d]# %(levelname)-8s [%(asctime)s]  %(message)s",
                    level=logging.DEBUG, filename="/smart_home/smart_home_api.log")
