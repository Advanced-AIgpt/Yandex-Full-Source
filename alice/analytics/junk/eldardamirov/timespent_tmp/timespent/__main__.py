...
def make_job(job, nirvana, options):
    ...
    tv = (
        job
            ...
            nf.and_(
                nf.or_(
                    nf.equals("platform", "hikeen"),
                    nf.equals("platform", "cv"),
                    nf.equals("platform", "cvte"),
                    nf.equals("platform", "SmartTV"),
                    nf.equals("platform", "gntch")
                ),
                nf.custom(lambda date: date == options.dates[0], "fielddate")
            )
        )
            .map(map_tv_table)
    )
