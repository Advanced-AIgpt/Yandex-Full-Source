window.app_dict = {
    "search_app_prod": "Поисковое приложение",
    "search_app_beta": "Поисковое приложение",
    "browser_prod": "Мобильный браузер",
    "browser_alpha": "Мобильный браузер",
    "browser_beta": "Мобильный браузер",
    "stroka": "Десктопный браузер",
    "navigator": "Навигатор",
    "launcher": "Яндекс.Лончер",
    "yandex_phone": "Яндекс.Лончер",
    "small_smart_speakers": "Яндекс.Станция",
    "quasar": "Яндекс.Станция",
    "auto": "Яндекс.Авто",
    "ru.yandex.autolauncher": "Яндекс.Авто",
    "elariwatch": "Умные часы",
    "other": "Поисковое приложение"
};


Handlebars.registerHelper('apps', function(item, options) {
  return window.app_dict[item] || "Мобильный браузер";
});
