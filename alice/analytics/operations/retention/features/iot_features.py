...
from alice.analytics.operations.retention.constants import IOT_FEATURES_PATH
...
def get_iot_daily_features(job, job_date):
    iot_features = job \
        .table('//home/alice/cubes/iot/last_devices') \
        .filter(
