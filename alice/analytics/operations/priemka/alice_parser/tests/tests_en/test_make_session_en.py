...
def test_all_ue2e_baskets_intents_directives_en():
    """
    ...
    input_path = data_path('test_make_session_en/03_all_ue2e_baskets_intents_directives.in.json', is_source_local=False)
