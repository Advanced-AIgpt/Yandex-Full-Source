...
simplify_url_cvt = make_subctitution_cvt("reverse-normalization/simplify_url.txt")

substitution_cvt = make_subctitution_cvt("reverse-normalization/substitution.txt")
