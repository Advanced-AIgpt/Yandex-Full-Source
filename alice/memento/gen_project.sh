...
"$DIR"/../../ya ide idea ${YA_COMMON_OPTS} ${YA_JDK_OPTS} $PLATFORM_FLAG --project-root="$HOME/IdeaProjects/memento" --directory-based --iml-in-project-root --generate-junit-run-configurations --local \
    $DIR/. \
    $DIR/../paskills/memento_snapshotter \
